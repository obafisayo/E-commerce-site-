...
const ItemsContainer = ({children, button, button1, button2, button2to, button2handler, productclass, scrollbutton, countdwn, title, subtitle}) => {
  ...
  return (
    <div className="flex items-center flex-col gap-10">
      <div className="flex w-full flex-col gap-10 max-sm:gap-5">
        <div className="w-full flex max-sm:flex-col max-sm:gap-3 max-sm:h-fit">
          <div className="lg:w-1/2 max-sm:w-full flex max-sm:flex-col max-sm:gap-4">
            <div className={`${countdwn? "w-2/5" : "w-full"} max-sm:w-full flex-col flex gap-5 justify-between`}>
              ...
              {subtitle && <div className="font-bold sm:text-4xl text-xl">
                <h1>{subtitle}</h1>
              </div>}
            </div>
